...
void standalone(char *fic);//new
void Refresh(const char *fic,const T_Position plateau);
...
void standalone_DEBUG(char *fic);
void Refresh_DEBUG(const char *fic,const T_Position plateau);